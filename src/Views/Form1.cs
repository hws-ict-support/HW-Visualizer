...
namespace HWS_Visualizer
{
    ...
    {
private const int SplitterDistance = 30;
        ...
        private void SelectAverCamera(string cameraName)
        {
            if (cameraName.Contains("AVer") || cameraName.Contains("Aver"))
            {
                cmbCameras.Text = cameraName;
            }
        }
        ...
        private void RefreshDevices()
        {
            ...
            {
                string cameraName = VideoCaptureDevice.Name;
                cmbCameras.Items.Add(cameraName);
                SelectAverCamera(cameraName);
            }

            btnGo.Enabled = cmbCameras.Items.Count > 0;
        ...
        {
            splitContainer1.Size = new Size(splitContainer1.Size.Width, SplitterDistance);
        ...
        private void timerAutoReconnect_Tick(object sender, EventArgs e)
        {
            ...
            catch (Exception exc) { Console.WriteLine($"Error in timerAutoReconnect_Tick: {exc.Message}"); }
        }
